...
iface.launch()
# Farklı bir yoldan denedim ve bununla resimler daha tutarlı oluştu. Asıl başarılı olan sonuncusu ama diğerlerini de eklemek istedim
...
# Dil modeli yüklemek için
model_name = "google/flan-t5-large"
tokenizer = AutoTokenizer.from_pretrained(model_name)
model = AutoModelForSeq2SeqLM.from_pretrained(model_name)

# Görsel modeli yüklemek için
device = "cuda" if torch.cuda.is_available() else "cpu"
pipe = StableDiffusionPipeline.from_pretrained(
...
iface.launch()
# Sesle denedim fakat başarılı sonuç alamadım henüz
